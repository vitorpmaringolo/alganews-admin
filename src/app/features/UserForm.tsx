...
import { FileService, User, UserService } from 'vitorpmaringolo-sdk';
    ...
    <Form
      ...
      onFinish={async (user: User.Input) => {
        ...
        const userDTO: User.Input = {
          ...
          taxpayerId: user.taxpayerId.replaceAll(/\D/g, ''),
        };
                ...
                <Col xs={24} lg={8}>
                  <Form.Item
                    ...
                    rules={[
                      ...
                      {
                        max: 20,
                        message: `O número da conta precisa ter no máximo 20 caracteres`,
                      },
                      {
                        min: 1,
                        message: `O número da conta precisa ter no mínimo 1 caractere`,
                      },
                    ]}
                  >
